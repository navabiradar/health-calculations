 ...
 * @param {number} exercise  - No. of days (0-7) person do exercise .
 * @returns {number} Calories kcal/day.
 */

try {
    function calorie(gender, age, weight, weightType, height, heightType, exercise) {
        ...
        switch (exercise) {
            case 0:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.2;
                break;
            case 1:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.4;
                break;
            case 2:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.6;
                break;
            case 3:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.6;
                break;
            case 4:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.75;
                break;
            case 5:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 1.75;
                break;
            case 6:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 2.0;
                break;
            case 7:
                calculatedCalorie = ((weightKg * 10) + (6.25 * heightCm) - (5 * age) + ((gender === "Male" ? MALE_FACTOR : FEMALE_FACTOR))) * 2.3;
                break;
            default:
